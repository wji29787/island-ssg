...
// node_modules/.pnpm/tsup@8.0.2_typescript@5.1.3/node_modules/tsup/assets/cjs_shims.js
...
async function build(root = process.cwd()) {
  ...
  const { render } = await Promise.resolve().then(() => _interopRequireWildcard(require(_url.pathToFileURL.call(void 0, serverEntryPath).pathname)));
...
var cli = _cac.cac.call(void 0, "islend").version(version).help();
